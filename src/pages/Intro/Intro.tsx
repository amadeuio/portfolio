  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="relative flex max-w-lg flex-col gap-2">
        <ProfilePicture className="absolute -top-8 right-0 max-[580px]:-top-16 max-[494px]:static max-[494px]:top-auto max-[494px]:right-auto max-[494px]:-translate-y-12 max-[494px]:self-center" />
        <div className="flex items-center gap-x-4">
          <Title level={1} className="max-[419px]:text-5xl">
            {t('hi')},
          </Title>
          <img
            className="h-16 w-16 max-[419px]:h-12 max-[419px]:w-12"
