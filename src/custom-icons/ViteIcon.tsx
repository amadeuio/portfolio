export const ViteIcon = () => (
  <svg
    className="fill-primary h-[18px] w-[18px]"
    viewBox="0 0 32 32"
  ...
  >
    ...
    <defs id="defs50">
      ...
      >
        <stop stop-color="var(--color-primary)" id="stop38"></stop>
        <stop offset="1" stop-color="var(--color-primary)" id="stop40"></stop>
      </linearGradient>
      <linearGradient
        id="paint1_linear"
        x1="194.651"
        ...
        gradientTransform="matrix(.07142 0 0 .07142 1.3398 1.8944)"
      >
        <stop stop-color="var(--color-primary)" id="stop43"></stop>
        <stop offset=".0833" stop-color="var(--color-tertiary)" id="stop45"></stop>
        <stop offset="1" stop-color="var(--color-background)" id="stop47"></stop>
      </linearGradient>
    </defs>
  </svg>
);
